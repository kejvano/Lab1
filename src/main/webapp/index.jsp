...
<%@ page import="application.dto.ProductDTO" %>
...
<nav>
    ...
    <c:if test="${sessionScope.user.permissionLevel != 'Worker'}">
    ...
    <c:if test="${sessionScope.user != null && sessionScope.user.permissionLevel == 'Customer' }">
        <h3>Cart</h3>
